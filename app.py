...
def insertintostock():
    ...
    try:
        ...
        return render_template('results.html', quote=quote, arima_pred=round(arima_pred, 2),
                               lstm_pred=round(lstm_pred, 2), lr_pred=round(lr_pred, 2),
                               ...
                               forecast_set=forecast, dates=dates, final_currency=final_currency,
                               error_lr=round(error_lr, 2), error_lstm=round(error_lstm, 2),
