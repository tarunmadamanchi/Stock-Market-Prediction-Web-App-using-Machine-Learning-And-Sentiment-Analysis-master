...
def contact_us_mail_sending():
    try:
        ...
        session.quit()
        print("name :"+name+"email :"+email+"subject :"+subject+"message :"+contact_message)
        return render_template('contact_us.html',status="success")
    except Exception as e:
        return render_template('contact_us.html',status=str(e))
...
def insertintotable():
    ...
    def get_historical(quote):
        ...
        print(quote)
        data = web.DataReader(quote, 'yahoo', start, end)
