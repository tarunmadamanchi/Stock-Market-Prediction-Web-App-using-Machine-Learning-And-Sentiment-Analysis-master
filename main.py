# -*- coding: utf-8 -*-
"""
Created on Fri Feb 14 06:36:49 2022

@author: Tarun Madamanchi
"""
#**************** IMPORT PACKAGES ********************
...
def dashboard():
    ...
    return render_template('dashboard.html',column_names=result.columns.values, row_data=list(result.values.tolist()), zip=zip)
...
@app.route('/insertintostock',methods = ['POST'])
def insertintostock():
    nm = request.form['nm']
    #**************GET DATA ***************************************
    quote=nm
    ...
    try:
        ...
        return render_template('results.html',quote=quote,arima_pred=round(arima_pred,2),lstm_pred=round(lstm_pred,2),
                               ...
                               forecast_set=forecast,dates=dates,final_currency=final_currency,error_lr=round(error_lr,2),error_lstm=round(error_lstm,2),error_arima=round(error_arima,2))
